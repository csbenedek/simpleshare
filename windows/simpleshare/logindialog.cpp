...
void LoginDialog::connectUi()
{
    ...
    connect(ui->confirmPasswordLineEdit, SIGNAL(textChanged(QString)), this, SLOT(onPasswordTextChanged(QString)));
    connect(ui->passwordLineEdit_2, SIGNAL(textChanged(QString)), this, SLOT(onPasswordTextChanged(QString)));
...
void LoginDialog::onPasswordTextChanged(QString text)
{
    ...
    {
        confirmWidget->setErrorMode(false);
        confirmWidget->setErrorMode(false);
    }
}
