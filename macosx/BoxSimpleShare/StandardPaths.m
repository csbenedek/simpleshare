...
//    NSArray * paths = [self URLsForDirectory:NSDownloadsDirectory inDomains:NSUserDomainMask];
//    return [paths objectAtIndex:0];

    struct passwd *pw = getpwuid(getuid());
    assert(pw);
    return [[NSString stringWithUTF8String:pw->pw_dir] stringByAppendingPathComponent:@"Desktop"];
}
@end
